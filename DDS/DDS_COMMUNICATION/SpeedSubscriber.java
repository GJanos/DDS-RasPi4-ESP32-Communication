 ...
 */
public class SpeedSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private SpeedDataReader reader = null;
    private final SpeedSeq dataSeq = new SpeedSeq();
    ...
    private void runApplication() {
        ...
        reader = (SpeedDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (SpeedSubscriber subscriberApplication = new SpeedSubscriber()) {
