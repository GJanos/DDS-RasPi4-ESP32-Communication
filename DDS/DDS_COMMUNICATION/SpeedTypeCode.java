...
public class  SpeedTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("speed", false, (short)-1,  false, TypeCode.TC_DOUBLE, 3, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("Speed",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);        
        return tc;
    }
}
