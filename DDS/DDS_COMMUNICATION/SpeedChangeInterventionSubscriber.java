...
*/
public class SpeedChangeInterventionSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private SpeedChangeInterventionDataReader reader = null;
    private final SpeedChangeInterventionSeq dataSeq = new SpeedChangeInterventionSeq();
    ...
    private void runApplication() {
        ...
        String typeName = SpeedChangeInterventionTypeSupport.get_type_name();
        SpeedChangeInterventionTypeSupport.register_type(participant, typeName);

        // Create a Topic with a name and a datatype
        Topic topic = Objects.requireNonNull(
            participant.create_topic(
                "SpeedChangeInterventionTopic",
                typeName,
                DomainParticipant.TOPIC_QOS_DEFAULT,
                null, // listener
                StatusKind.STATUS_MASK_NONE));

        // This DataReader reads data on "Example SpeedChangeIntervention" Topic
        reader = (SpeedChangeInterventionDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (SpeedChangeInterventionSubscriber subscriberApplication = new SpeedChangeInterventionSubscriber()) {
