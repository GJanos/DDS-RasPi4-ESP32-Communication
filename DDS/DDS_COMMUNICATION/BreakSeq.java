...
/**
* A sequence of Break instances.
*/
public final class BreakSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BreakSeq (int initialMaximum) {
        super(Break.class, initialMaximum);
    }

    public BreakSeq (Collection<?> elements) {
        super(Break.class, elements);
    }

    public  Break get(int index) { 
        return (Break) super.get(index); 
    }
    ...
    */
    ...
    public java.lang.Object copy_from(java.lang.Object src) {
        ...
        // copy 'new' Break objects (beyond the original size of this object)
