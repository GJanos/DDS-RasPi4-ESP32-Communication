...
public class BreakTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "Break";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakTypeSupport _singleton
    = new BreakTypeSupport();
    ...
    */
    public static BreakTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Break</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        Break typedDst = (Break) destination;
        Break typedSrc = (Break) source;
    ...
    int mask) {
        return new BreakDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BreakDataReader(native_reader, listener, mask, this);   
    ...
    protected BreakTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, BreakTypeCode.VALUE, Break.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, BreakTypeCode.VALUE, Break.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
