...
public class SpeedTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "Speed";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SpeedTypeSupport _singleton
    = new SpeedTypeSupport();
    ...
    */
    public static SpeedTypeSupport get_instance() {
        return _singleton;
    }

    public static SpeedTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SpeedTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Speed</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        Speed typedDst = (Speed) destination;
        Speed typedSrc = (Speed) source;
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.speed);
            if(!xcdr1){            
    ...
    int mask) {
        return new SpeedDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SpeedDataReader(native_reader, listener, mask, this);   
    ...
    protected SpeedTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, SpeedTypeCode.VALUE, Speed.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SpeedTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, SpeedTypeCode.VALUE, Speed.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
