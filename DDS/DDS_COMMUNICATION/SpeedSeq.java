...
/**
* A sequence of Speed instances.
*/
public final class SpeedSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SpeedSeq (int initialMaximum) {
        super(Speed.class, initialMaximum);
    }

    public SpeedSeq (Collection<?> elements) {
        super(Speed.class, elements);
    }

    public  Speed get(int index) { 
    ...
    */
    ...
    public java.lang.Object copy_from(java.lang.Object src) {
        ...
        // copy 'new' Speed objects (beyond the original size of this object)
