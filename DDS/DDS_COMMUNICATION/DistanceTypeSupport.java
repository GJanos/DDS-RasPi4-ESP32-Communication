...
public class DistanceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "Distance";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DistanceTypeSupport _singleton
    = new DistanceTypeSupport();
    ...
    */
    public static DistanceTypeSupport get_instance() {
        return _singleton;
    }

    public static DistanceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DistanceTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Distance</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        Distance typedDst = (Distance) destination;
        Distance typedSrc = (Distance) source;
        ...
        java.lang.Object sample)
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Distance typedSrc = (Distance) sample;
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            Distance typedDst = (Distance) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (deserialize_key) {
            ...
            Distance typedDst = (Distance) sample;
            deserialize_sample(
    ...
    int mask) {
        return new DistanceDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DistanceDataReader(native_reader, listener, mask, this);   
    ...
    protected DistanceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, DistanceTypeCode.VALUE, Distance.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DistanceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, DistanceTypeCode.VALUE, Distance.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
