...
* SpeedChangeIntervention
*/

public class SpeedChangeInterventionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "SpeedChangeIntervention";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SpeedChangeInterventionTypeSupport _singleton
    = new SpeedChangeInterventionTypeSupport();
    ...
    */
    public static SpeedChangeInterventionTypeSupport get_instance() {
        return _singleton;
    }

    public static SpeedChangeInterventionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SpeedChangeInterventionTypeCode.VALUE;
    }

    @Override
    public java.lang.Object create_data() {
        return SpeedChangeIntervention.create();
    }
    ...
    public java.lang.Object create_key() {
        return new SpeedChangeIntervention();
    }
    ...
    public java.lang.Class<?> get_type() {
        return SpeedChangeIntervention.class;
    }
    ...
    * <code>this</code> is not a <code>SpeedChangeIntervention</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        SpeedChangeIntervention typedDst = (SpeedChangeIntervention) destination;
        SpeedChangeIntervention typedSrc = (SpeedChangeIntervention) source;
    ...
    public long get_serialized_sample_max_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (256)+1);
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (256)+1);
        ...
        java.lang.Object sample)
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        SpeedChangeIntervention typedSrc = (SpeedChangeIntervention) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.id );
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.id,256);
            dst.writeString(typedSrc.message,256);
            dst.writeLong(typedSrc.timestamp);
            dst.writeDouble(typedSrc.amount);
            if(!xcdr1){            
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            SpeedChangeIntervention typedDst = (SpeedChangeIntervention) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.id = src.readString(256);
                typedDst.message = src.readString(256);
                typedDst.timestamp = src.readLong();
                typedDst.amount = src.readDouble();
    ...
    public java.lang.String data_to_string(
        SpeedChangeIntervention sample,
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (deserialize_key) {
            ...
            SpeedChangeIntervention typedDst = (SpeedChangeIntervention) sample;
            deserialize_sample(
    ...
    int mask) {
        return new SpeedChangeInterventionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SpeedChangeInterventionDataReader(native_reader, listener, mask, this);   
    ...
    protected SpeedChangeInterventionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, SpeedChangeInterventionTypeCode.VALUE, SpeedChangeIntervention.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SpeedChangeInterventionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, SpeedChangeInterventionTypeCode.VALUE, SpeedChangeIntervention.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
