 ...
 */
public class DistanceSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private DistanceDataReader reader = null;
    private final DistanceSeq dataSeq = new DistanceSeq();
    ...
    private void runApplication() {
        ...
        reader = (DistanceDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (DistanceSubscriber subscriberApplication = new DistanceSubscriber()) {
