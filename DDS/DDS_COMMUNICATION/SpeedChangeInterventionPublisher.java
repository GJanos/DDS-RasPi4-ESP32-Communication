...
*/
public class SpeedChangeInterventionPublisher extends Application implements AutoCloseable {
    ...
    private void runApplication() {
        ...
        SpeedChangeInterventionDataWriter writer = (SpeedChangeInterventionDataWriter) Objects.requireNonNull(
        ...
        SpeedChangeIntervention data = new SpeedChangeIntervention();
        ...
        && samplesWritten < getMaxSampleCount(); samplesWritten++) {
            ...
            System.out.println("Writing SpeedChangeIntervention, count " + samplesWritten);
    ...
    public static void main(String[] args) {
        ...
        try (SpeedChangeInterventionPublisher publisherApplication = new SpeedChangeInterventionPublisher()) {
